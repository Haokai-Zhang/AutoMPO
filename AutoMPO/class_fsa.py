...
Creation Date: 2021-07-01 11:00
Description: AutoMPO project. <class_fsa.py> contains finite-state automata generating matrix product operator automatically.
'''
